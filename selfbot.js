...
//stealpfp
  if (command === "stealpfp"){
    ...
    if (command === "purge"){
      ...
      msg.channel.send(new RichEmbed().setDescription(`${msg.author.tag} hugs ${user.tag}`).setColor("ff99fa").setImage(body.url)).then(message => message.delete(6100));     
}
  //GAY
...
function ran(min, max) { // min and max included 
    return Math.floor(Math.random() * (max - min + 1) + min);
      ...
      if(!user) return msg.reply('You forgot to mention a user.')
      msg.channel.send(new RichEmbed().setDescription(`${msg.author.tag} kisses ${user.tag}`).setColor("ff99fa").setImage(body.url)).then(message => message.delete(6100));    
}
  //SLAP
        if (command === "slap") {
      ...
      if(!user) return msg.reply('You forgot to mention a user.')
      msg.channel.send(new RichEmbed().setDescription(`${msg.author.tag} SLAP ${user.tag}`).setColor("ff99fa").setImage(body.url)).then(message => message.delete(6100));    
}
  //FUCK
          if (command === "fuck") {
      ...
      if(!user) return msg.reply('You forgot to mention a user.')
      msg.channel.send(new RichEmbed().setDescription(`${msg.author.tag} This Message WIll Be Deleted In 3 Seconds Due Disabling Account ${user.tag}`).setColor("ff99fa").setImage(body.url)).then(message => message.delete(6100));    
}
  //FEED
            if (command === "feed") {
      ...
      if(!user) return msg.reply('You forgot to mention a user.')
      msg.channel.send(new RichEmbed().setDescription(`${msg.author.tag} is feeding ${user.tag}`).setColor("ff99fa").setImage(body.url)).then(message => message.delete(6100));    
}
  //TOKEN
...
if (command === "translist") {
    ...
    msg.channel.send(embed);
     ...
     if (command === "show"){
        ...
        if (args.length < 1){
         let embed = new Discord.RichEmbed()
            .setThumbnail('https://media.discordapp.net/attachments/637851827429310464/778044937908387840/246aa7491313e6c5e81335a0261cc4c0.gif')
            .setAuthor("[KBG Selfbot]")
            .setTitle("Prefix: X  ")
            .setDescription("*Use xshow [category] for more info*")
            .setColor("#ff99fa")
        ...
        if (haste.toLowerCase() === "Nuke") {
            let gay = new Discord.RichEmbed()
            .setThumbnail('hhttps://images-ext-2.discordapp.net/external/v9paTftX8_WB0cyrVZRtHFxWriM_tDV3T0338wuzFrA/https/media.discordapp.net/attachments/637851827429310464/778044937908387840/246aa7491313e6c5e81335a0261cc4c0.gif?width=225&height=270')
            .setAuthor("[KBG Selfbot]")
            .setColor("#ff99fa")
            .setImage('')
        ...
        if (haste.toLowerCase() === "kb") {
            ...
            .setDescription("")
            .setColor("#ff99fa")
            .AddField("KruhxBraple", "`> Kruh/Braple` | < \n `> Best` | < \n `> Duo`.")
            .setImage('')
